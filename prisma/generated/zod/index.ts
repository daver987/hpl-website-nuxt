...
export const QuoteScalarFieldEnumSchema = z.enum(['quote_number','created_at','updated_at','selected_hours','selected_passengers','is_round_trip','is_booked','user_id','quote_total','quote_subtotal','quote_tax_total','service_id','vehicle_id','sales_tax_id']);
