...
import utils, { getCountry, setCaretPosition } from './utils.js'
...
export default {
  ...
  computed: {
    ...
    phoneObject() {
      ...
      const result =
        this.phone?.[0] === '+'
          ? parsePhoneNumberFromString(this.phone) || {}
      ...
      if (
        ...
        !this.findCountry(result.country)
      ) {
        valid = false
        Object.assign(result, { country: '--' })
      }
  ...
  methods: {
      ...
      if (e.keyCode === 40) {
        ...
        this.selectedIndex =
          this.selectedIndex === null
            ? 0
            : Math.min(this.sortedCountries.length - 1, this.selectedIndex + 1)
    ...
    setDropdownPosition() {
      ...
      this.dropdownOpenDirection = hasEnoughSpaceBelow ? 'below' : 'above'
    },
  },
}
</script>
